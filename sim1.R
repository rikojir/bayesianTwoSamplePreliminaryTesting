...
sim = function(alpha){
  ...
  for(i in 1:length(n)){
    ...
    JZSBF1N[j,i]=extractBF(ttestBF(x=xDat,y=yDat,paired=FALSE))$bf # BF_10 for alternative delta is cauchy with scale r=0.707 against null of delta = 0 (no effect)
    }
  }
